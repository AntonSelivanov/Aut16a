...
display(['Theorem 1: Omega=' mat2str(LMI_Aut16a_th1(A,B,K,h,r0,etaM,r1,muM,alpha,sigma))]); 
display(['Proposition 1: Omega=' mat2str(LMI_Aut16a_prop1(A,B,K,h,etaM,alpha,sigma))]); 

%% LMIs of Theorem 2 and Proposition 2 
h=.104; r1=.2; muM=.01; alpha=.01; sigma=.13; 
display(['Theorem 2: Omega=' mat2str(LMI_Aut16a_th2(A,B,K,h,r1,muM,alpha,sigma))]); 
display(['Proposition 2: Omega=' mat2str(LMI_Aut16a_prop2(A,B,K,h,alpha,sigma))]); 
